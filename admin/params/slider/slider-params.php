...
if(!function_exists('ocoder_slider_range_settings')){
vc_add_shortcode_param( 'prime_slider', 'ocoder_slider_range_settings', plugin_dir_url( __FILE__ ) . 'js/slider-params.js');
function ocoder_slider_range_settings( $settings, $value ) {
	$defaults = array(
		'min'        => 0,
		'max'        => 100,
		'step'       => 1,
